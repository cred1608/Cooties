...
testCootie = [CT.Cootie(random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(10, 15),random.randint(0, 10),random.randint(1, 2),random.randint(100, 200),60,100, False, False),
              CT.Cootie(random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(10, 15),random.randint(0, 10),random.randint(1, 2),random.randint(100, 200),140,100, False, False),
              CT.Cootie(random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(10, 15),random.randint(0, 10),random.randint(1, 2),random.randint(100, 200),220,100, False, False),
              CT.Cootie(random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(10, 15),random.randint(0, 10),random.randint(1, 2),random.randint(100, 200),300,100, False, False),
              CT.Cootie(random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(10, 15),random.randint(0, 10),random.randint(1, 2),random.randint(100, 200),380,100, False, False),
              CT.Cootie(random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(10, 15),random.randint(0, 10),random.randint(1, 2),random.randint(100, 200),460,100, False, False),
              CT.Cootie(random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(10, 15),random.randint(0, 10),random.randint(1, 2),random.randint(100, 200),540,100, False, False),
              CT.Cootie(random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(10, 15),random.randint(0, 10),random.randint(1, 2),random.randint(100, 200),620,100, False, False),
              CT.Cootie(random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(10, 15),random.randint(0, 10),random.randint(1, 2),random.randint(100, 200),700,100, False, False),
              CT.Cootie(random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(0, 10),random.randint(10, 15),random.randint(0, 10),random.randint(1, 2),random.randint(100, 200),780,100, False, False)]
         ...
         for cootie in testCootie:
            if cootie.rect.collidepoint(pygame.mouse.get_pos()):
               if clickwait <=0:
                  if startingcootie2:
                     clickwait = 10
                     if cootie.gender != selectedCootie1.gender:
...
while carryOn:
    ...
    if CootieCount == 1 or dayindex == 99 or CootieCount >= 300:
       carryOn = False
       simOver = True
    for event in pygame.event.get(): # User did something
        if event.type == pygame.QUIT: # If user clicked close
    ...
    for cootie in testCootie:
      ...
      #check cootie to see if they mate   
       ...
       if cootie.deliver == True:
          ...
          mate.taken = False
    if CootieCount == 1 or CootieCount >= 250:
       simOver = True
       carryOn = False      
